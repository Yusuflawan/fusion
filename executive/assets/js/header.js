...
//               <i class="fi fi-rr-angle-down text-3xs me-1" id="username"></i>
//             </small>
//           </div>
...
//         </div>
    ...
    //     <li class="menu-item"><a class="menu-link" href="maps.html"><i class="fi fi-rr-map"></i><span class="menu-label">Compliance Map</span></a></li>
    //     <li class="menu-item"><a class="menu-link" href="LGA.html"><i class="fi fi-rr-shield-check"></i><span class="menu-label">LGA Performance</span></a></li>
    //     <li class="menu-item"><a class="menu-link" href="analytics.html"><i class="fi fi-rr-chart-histogram"></i><span class="menu-label">Strategic Analytics</span></a></li>
    //     <li class="menu-item"><a class="menu-link" href="report.html"><i class="fi fi-rr-clipboard-list"></i><span class="menu-label">Report</span></a></li>
    //   </ul>
    // </nav>
//     <div class="app-footer">
//       <a href="javascript:void(0)" class="btn btn-outline-danger waves-effect btn-shadow btn-app-nav w-100" id="sidebarLogout">
