  ...
  series: [
    {
      name: "Gross Salary",
      data: [
        55000, 60000, 68000, 52000, 69000, 73000, 71000, 74000, 70000, 75000,
        72000, 77000,
      ],
    },
    {
      name: "Net Salary",
      data: [
        25000, 27000, 16000, 15500, 16500, 17200, 15800, 17000, 16200, 16800,
        16000, 17500,
      ],
    },
    {
      ...
      type: "line",
      data: [
        25000, 50000, 40000, 20000, 52500, 45000, 55200, 47000, 25800, 58200,
        36000, 59500,
      ],
    },
  ],
...
if (
  typeof chartDailySalesStates !== undefined &&
  chartDailySalesStates !== null
) {
  var chartInit = new ApexCharts(
    chartDailySalesStates,
    chartDailySalesStatesConfig
  );
  chartInit.render();
}
