...
//                   <div class="fw-bold text-dark" id="loginName">siaa.o</div>
...
//                     <small class="text-body d-block lh-sm" id="loginEmail"
//                       >siaa@gmail.com</small
//                     >
//                   </div>
//                 </li>
//                 <li class="">
//                    <div class="account-switcher-container">
//                         <select id="accountSwitcher" class="form-select">
...
//             </li>
//             <li class="menu-item">
//               <a class="menu-link" href="mytax.html">
...
//                 <span class="menu-label">Tax Calculator</span>
//               </a>
//             </li>
//             <li class="menu-item">
...
//             </li>
//             <li class="menu-item">
//               <a class="menu-link" href="tax-alert.html">
...
//                 <span class="menu-label">Business Profile</span>
//               </a>
//             </li>
//           </ul>
//         </nav>
...
//   const email = activeAccount?.email || "test@gmail.com";
//   const name = activeAccount?.business_name || "alice";
...
<ul class="dropdown-menu dropdown-menu-end w-300 mt-1 p-2 shadow-sm border-0 rounded-3">
  <!-- User info -->
  <li class="d-flex align-items-center p-2">
    <img src="https://www.gravatar.com/avatar/?d=mp&s=200" 
         class="rounded-circle me-2" width="40" height="40" alt="User Avatar" />
    <div>
      <div class="fw-bold text-dark" id="username1">John Doe</div>
      <small class="text-muted d-block lh-sm" id="email">john@example.com</small>
    </div>
  </li>
    ...
    <div class="card border-0 shadow-sm mb-2">
      <div class="card-body p-3">
        <div class="d-flex align-items-center mb-2">
          ...
          <h6 class="card-title mb-0 fw-semibold">Switch Account</h6>
        </div>
        <select id="accountSwitcher" class="form-select form-select-sm rounded-3">
        </select>
      </div>
    </div>
  </li>
  ...
  <li>
    <button class="dropdown-item d-flex align-items-center text-danger" id="logoutBtn">
...
async function loadUser() {
  ...
  try {
    ...
    localStorage.setItem("default_account", JSON.stringify(user));
